    ...
    <ScrollView>
      <View style={styles.container}>
        <View style={styles.navBar}>
            <Image source={require('../Tugas13/Image/logo.png')} size={5} style={{width:187, height: 51}}/>
        </View>
        <View style={styles.descContainer}>
            <Image source={require('../Tugas13/Image/pas3x4.jpeg')} size={1} style={{width:43, height: 45,borderRadius:10}}/>
